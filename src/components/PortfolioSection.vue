  ...
  <div class="bg-[#181818] text-white">
    ...
    <nav
      ...
      <ul class="flex space-x-8">
        ...
        <li>
          <a href="#projects" class="text-green-400 hover:text-green-300 transition-colors">Projects</a>
        </li>
        <li>
          <a href="#contact" class="text-green-400 hover:text-green-300 transition-colors">Contact</a>
        </li>
      </ul>
    </nav>

    <!-- Scroll Container with custom scroll behavior -->
    <div class="snap-y snap-mandatory h-screen overflow-y-auto pt-16 scroll-smooth" style="
        scroll-behavior: smooth;
        -webkit-overflow-scrolling: touch;
        scroll-snap-type: y mandatory;
        scroll-behavior: smooth;
        transition: scroll-behavior 1000ms cubic-bezier(0.4, 0, 0.2, 1);
      ">
      <!-- Hero Section -->
      <section id="home"
        ...
        <div class="text-center">
          <p class="text-green-400 text-lg mb-4">
            ...
            <span ref="typingElement"
              class="text-xl font-bold text-green-400 animate-pulse min-w-[200px] text-left"></span>
          </p>

          <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-green-400 leading-tight">
            UI/UX<br />
            Designer
          </h1>
      ...
      <!-- About Section -->
      <section id="about" class="snap-start min-h-[calc(100vh-4rem)] flex items-center py-8 overflow-hidden relative"
        ref="aboutSection" style="height: 100vh">
        <div class="w-full px-4 sm:px-8 max-w-6xl mx-auto my-auto">
          <div class="flex items-start gap-8 md:gap-12 mobile-stack">
            ...
            <div class="flex-shrink-0 w-1/3 sm:w-1/4 md:w-1/3 lg:w-1/3 mobile-image">
              <img :src="KyleProfileImage" alt="Kyle Arana Profile"
                class="w-full h-56 sm:h-64 md:h-80 lg:h-96 object-cover rounded-lg shadow-lg mt-10" />
            </div>

            <!-- About Content (Right side on desktop, bottom on mobile) -->
            <div class="flex-1 mobile-text p-4">
              <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-green-400 mb-4 md:mb-6">
                About me
              </h2>
              <p class="text-gray-300 leading-relaxed mb-6 md:mb-8 text-sm sm:text-base">
                Hi, I'm <span class="font-semibold text-green-400">Kyle Araña</span>, a
                <span class="font-semibold text-green-400">UI/UX Designer</span> and
                <span class="font-semibold text-green-400">Front-End Developer</span>
                who crafts intuitive digital experiences that deliver real results.
                <br />
                <br />
                At VIPTutors, I rebuilt the design system with a scalable Figma library, boosting design-dev efficiency
                by <b>40%</b> and increasing conversions by <b>18%</b> across 50+ pages and campaigns.
                <br />
                <br />
                In my role at AVICentral, I merged design and development to create seamless CRM workflows, reducing
                task completion time by <b>15%</b> while aligning every interface with brand and usability goals.
                <br />
                <br />
                I've also built full-stack systems that cut manual work by up to <b>90%</b>, streamlining operations
                significantly.
                <br />
                <br />
                I blend design thinking with technical execution using React, Vue.js, TypeScript, Figma, and more — from
                concept to polished, functional products.
                <br />
                <br />
      ...
      <section id="services" class="snap-start min-h-[calc(100vh-4rem)] flex items-center bg-[#181818] py-16">
        <div class="w-full px-4 sm:px-8 max-w-6xl mx-auto my-auto">
          <div class="text-center mb-16" style="margin-bottom: 20px; margin-top: 20px">
            <h2 class="text-5xl sm:text-6xl md:text-7xl font-bold text-green-400 mb-6">Services</h2>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-1 sm:gap-8">
          ...
          <div
            ...
            <div class="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3 cursor-pointer" @click="toggleCollapse(3)">
              <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"
                  ...
                  class="lucide lucide-palette text-white" preserveAspectRatio="xMidYMid meet">
                  <path
              ...
              <div class="flex-shrink-0 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="text-green-400 transition-transform duration-300" :class="{ 'rotate-180': expandedStates[3] }">
          ...
          <div
            class="border-2 border-green-400 rounded-xl p-6 sm:p-8 bg-[#181818] hover:bg-[#2a2a2a] transition-all duration-300 mx-4 sm:mx-6 md:mx-8"
            style="padding-bottom: 10px">
            <div class="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3 cursor-pointer" @click="toggleCollapse(0)">
              <div
                class="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-[#2a2a2a] rounded-full flex-shrink-0 flex items-center justify-center p-1 sm:p-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-monitor text-white" preserveAspectRatio="xMidYMid meet">
              ...
              <div class="flex-shrink-0 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="text-green-400 transition-transform duration-300" :class="{ 'rotate-180': expandedStates[0] }">
                  <polyline points="6,9 12,15 18,9"></polyline>
                </svg>
              </div>
            </div>
          ...
          <div
            class="border-2 border-green-400 rounded-xl p-6 sm:p-8 bg-[#181818] hover:bg-[#2a2a2a] transition-all duration-300 mx-4 sm:mx-6 md:mx-8"
            style="padding-bottom: 10px">
            <div class="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3 cursor-pointer" @click="toggleCollapse(2)">
              <div
                class="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-[#2a2a2a] rounded-full flex-shrink-0 flex items-center justify-center p-1 sm:p-1.5">
              ...
              <div class="flex-shrink-0 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="text-green-400 transition-transform duration-300" :class="{ 'rotate-180': expandedStates[2] }">
                  <polyline points="6,9 12,15 18,9"></polyline>
                </svg>
              </div>
            </div>
          ...
          <div
            class="border-2 border-green-400 rounded-xl p-6 sm:p-8 bg-[#181818] hover:bg-[#2a2a2a] transition-all duration-300 mx-4 sm:mx-6 md:mx-8"
            style="padding-bottom: 10px">
            <div class="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3 cursor-pointer" @click="toggleCollapse(1)">
              <div
                class="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-[#2a2a2a] rounded-full flex-shrink-0 flex items-center justify-center p-1 sm:p-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-code text-white" preserveAspectRatio="xMidYMid meet">
              ...
              <div class="flex-shrink-0 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="text-green-400 transition-transform duration-300" :class="{ 'rotate-180': expandedStates[1] }">
                  <polyline points="6,9 12,15 18,9"></polyline>
                </svg>
              </div>
            </div>
      ...
      <!-- Techstack Section -->
      <section id="techstack" class="snap-start min-h-[calc(100vh-4rem)] flex items-center bg-[#181818] py-16">
        <div class="w-full px-4 sm:px-8 max-w-6xl mx-auto my-auto">
          <div class="text-center mb-16" style="margin-top: 20px; margin-bottom: 40px">
            <h2 class="text-5xl sm:text-6xl md:text-7xl font-bold text-green-400 mb-6">
              Tech Stack
            </h2>
          ...
          <!-- Tech Stack Grid -->
          <div class="grid grid-cols-3 gap-6 lg:grid-cols-7 lg:gap-8 max-w-7xl mx-auto px-4 sm:px-8 md:px-12">
            <!-- Figma -->
            <div class="flex flex-col items-center">
              ...
              <p class="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed mt-4 font-medium text-center">
                Figma
              </p>
            </div>
            ...
            <!-- Claude-->
            <div class="flex flex-col items-center">
              <svg width="70" height="70" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
              ...
              <p class="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed mt-4 font-medium">
                Claude
              </p>
            </div>
            ...
            <!-- PocketBase -->
            <div class="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 25 30">
      ...
      <section id="expertise" class="snap-start min-h-[calc(100vh-4rem)] flex items-center bg-[#181818] py-16">
        <div class="w-full px-4 sm:px-8 max-w-6xl mx-auto my-auto">
          <div class="text-center mb-16" style="margin-top: 20px; margin-bottom: 40px">
            <h2 class="text-5xl sm:text-6xl md:text-7xl font-bold text-green-400 mb-6">
              Other Expertise
            ...
            <p class="text-sm sm:text-base text-gray-400 mb-4">
              Additional tools and software I'm proficient with
            </p>
          </div>

          <!-- Other Expertise Icons - 3x3 Mobile, 7x7 Desktop -->
          <div class="grid grid-cols-3 gap-6 sm:grid-cols-7 sm:gap-8 max-w-7xl mx-auto px-4 sm:px-8 md:px-12">
            <!-- Canva -->
            <div class="flex flex-col items-center">
              <svg width="70" height="70" viewBox="0 0 128 128">
                <g fill="#00c4cc">
            ...
            <div class="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 32 32">
                ...
                <path d="M16.434 8.2H8.512v16.25h7.922a1.2 1.2 0 0 0 1.194-1.191V9.391A1.2 1.2 0 0 0 16.434 8.2Z"
                  opacity=".1" />
            ...
            <div class="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 32 32">
                <defs>
                  <linearGradient id="vscodeIconsFileTypePowerpoint0" x1="4.494" x2="13.832" y1="-1748.086"
                    y2="-1731.914" gradientTransform="translate(0 1756)" gradientUnits="userSpaceOnUse">
      ...
      <footer id="contact"
        ...
        <div class="w-full">
          ...
          <div class="absolute inset-0 opacity-5">
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(34,197,94,0.05),transparent_70%)]">
            </div>
            <div
              class="absolute inset-0 bg-[linear-gradient(45deg,transparent_48%,rgba(34,197,94,0.05)_49%,rgba(34,197,94,0.05)_51%,transparent_52%)] bg-[length:20px_20px]">
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div class="lg:col-span-2">
                <div class="mb-6">
                  ...
                  <div class="h-1 w-16 bg-gradient-to-r from-green-400 to-green-600 rounded-full"></div>
                </div>
                ...
                <div class="flex space-x-4">
                  <!--Github-->
                  <a href="https://github.com/kasho-dev" target="_blank"
                  ...
                  <!--LinkedIn-->
                  <a href="https://www.linkedin.com/in/kyle-araña-40746436a/" target="_blank"
                    class="group relative p-3 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg hover:border-green-400 transition-all duration-300 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <!--Facebook-->
                  <a href="https://www.facebook.com/ripkazeo/" target="_blank"
                    class="group relative p-3 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg hover:border-green-400 transition-all duration-300 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <!--Dribbble-->
                  <a href="https://dribbble.com/kashodev" target="_blank"
                    class="group relative p-3 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg hover:border-green-400 transition-all duration-300 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              ...
              <!-- Quick Links -->
              <div>
                <h4 class="text-xl font-semibold text-white mb-6 relative">
                  Quick Links
                  <div class="absolute -bottom-2 left-0 w-8 h-0.5 bg-green-400 rounded-full"></div>
                </h4>
                <ul class="space-y-3">
                  <li>
                    <a href="#about"
                      class="text-gray-300 hover:text-green-400 transition-colors duration-300 hover:translate-x-1 inline-block">About</a>
                  </li>
                  <li>
                    <a href="#projects"
                      class="text-gray-300 hover:text-green-400 transition-colors duration-300 hover:translate-x-1 inline-block">Projects</a>
                  </li>
                  <li>
                    <a href="#services"
                      class="text-gray-300 hover:text-green-400 transition-colors duration-300 hover:translate-x-1 inline-block">Services</a>
                  </li>
                  <li>
                    <a href="#contact"
                      class="text-gray-300 hover:text-green-400 transition-colors duration-300 hover:translate-x-1 inline-block">Contact</a>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-center space-x-3 group">
                    ...
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kyle.arana97@gmail.com" target="_blank">
                  ...
                  <div class="flex items-center space-x-3 group">
                    ...
                    <span class="text-gray-300">+63 992 641 1827</span>
                  </div>
                  ...
                  <div class="flex items-center space-x-3 group">
                    ...
                    <span class="text-gray-300">Legazpi City, PH</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div
            class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-green-400 to-transparent opacity-50">
          </div>
        </div>
      </footer>
    </div>
  ...
  const observer = new IntersectionObserver(
    ([entry]) => {
      if (entry.isIntersecting) {
        aboutSection.value?.classList.remove('animate__fadeOut-slow')
        aboutSection.value?.classList.add('animate__fadeIn-slow')
      } else {
        aboutSection.value?.classList.remove('animate__fadeIn-slow')
        aboutSection.value?.classList.add('animate__fadeOut-slow')
      }
    },
    { threshold: 0.1 },
  )
...
.snap-y {
  ...
  /* IE and Edge */
  scroll-timeline: --smooth-scroll y;
  animation: auto ease-in-out smooth-scroll both;
  animation-timeline: --smooth-scroll;
  animation-duration: 1.5s;
  /* Adjust this value to make the scroll slower (e.g., 1.5s, 2s) */
}
