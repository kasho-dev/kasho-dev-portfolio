<template>
  <div class="bg-[#181818] text-white">
    ...
    >
      ...
      <section
        id="about"
        class="snap-start min-h-[calc(100vh-4rem)] flex items-center py-8 overflow-hidden relative"
        ref="aboutSection"
        style="height: 100vh"
      >
          ...
          >
            <div class="flex gap-4 sm:gap-6 md:gap-8 w-max mx-auto">
              ...
              >
                ...
                <div class="mb-2">
                  <span
                    class="text-green-400 text-sm sm:text-base uppercase tracking-wide font-medium"
                  >
                    {{ project.techStack[0] }}
                  </span>
                </div>
                ...
                <h3
                  class="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-white leading-tight"
                >
                  {{ project.title }}
                </h3>
              </div>
            ...
            >
              ...
              <div class="flex-shrink-0 ml-2">
                <svg
                  ...
                  :class="{ 'rotate-180': expandedStates[0] }"
                >
            ...
            >
              ...
              <div class="flex-shrink-0 ml-2">
                <svg
                  ...
                  stroke-linejoin="round"
                  class="text-green-400 transition-transform duration-300"
                  :class="{ 'rotate-180': expandedStates[2] }"
                >
                  <polyline points="6,9 12,15 18,9"></polyline>
                </svg>
              </div>
      ...
      >
        <div class="w-full px-4 sm:px-8 max-w-6xl mx-auto my-auto">
          ...
          <div
            class="grid grid-cols-3 gap-6 sm:grid-cols-7 sm:gap-8 max-w-7xl mx-auto px-4 sm:px-8 md:px-12"
          >
            <!-- Canva -->
            <div class="flex flex-col items-center">
              <svg width="70" height="70" viewBox="0 0 128 128">
